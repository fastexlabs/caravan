...
func TestGenerateCorruptAccountTrie(t *testing.T) {
	...
	helper.addTrieAccount("acc-1", &Account{Balance: big.NewInt(1), Root: emptyRoot.Bytes(), CodeHash: emptyCode.Bytes()}) // 0xd0d8cdc82d3cc6bb1f75f43ed2ba03a4ce390176d16eca008f15e58ca3a4f2dd
	helper.addTrieAccount("acc-2", &Account{Balance: big.NewInt(2), Root: emptyRoot.Bytes(), CodeHash: emptyCode.Bytes()}) // 0xb6fbfa3235dc84a9eca7b4cd91710e768f2f37e1024f6625ad6a66f81fee848f
	helper.addTrieAccount("acc-3", &Account{Balance: big.NewInt(3), Root: emptyRoot.Bytes(), CodeHash: emptyCode.Bytes()}) // 0x524eb8eb4947ebd5461730ad58e07e1347d3710999126b0aea0bf44ff0f1e2df

	root := helper.Commit() // Root: 0xa04693ea110a31037fb5ee814308a6f1d76bdab0b11676bdf4541d2de55ba978

	// Delete an account trie leaf and ensure the generator chokes
	helper.triedb.Commit(root, false, nil)
	helper.diskdb.Delete(common.HexToHash("0xb6fbfa3235dc84a9eca7b4cd91710e768f2f37e1024f6625ad6a66f81fee848f").Bytes())
